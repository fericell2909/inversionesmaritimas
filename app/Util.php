...
class Util extends Model
{
    ...
    public static $modo_facturacion = 0  ; // 0:desarrolllo 1:produccion
	public static $ruta_certificado = __DIR__.'\certificate.pem';
	public static $usuario_certificado = '20000000001MODDATOS';
	public static $pass_certificado = 'moddatos';

    public static $emisor_setUbigueo= '150101';
	public static $emisor_setDepartamento = 'LIMA';
	public static $emisor_setProvincia = 'LIMA';
	public static $emisor_setDistrito = 'LIMA';
	public static $emisor_setUrbanizacion = 'NONE';
	public static $emisor_setDireccion = 'AV LS';

	public static $emisor_setRuc = '20000000001';
	public static $emisor_setRazonSocial='EMPRESA SAC';
	public static $emisor_setNombreComercial='EMPRESA';
...
//        $see->setCodeProvider(new XmlErrorCodeProvider());
        $see->setCertificate(file_get_contents(Util::$ruta_certificado));
        $see->setCredentials(Util::$usuario_certificado, Util::$pass_certificado);
...
HTML;
    ...
    public function writeFile($filenam, $content)
    {
        ...
        file_put_contents(__DIR__ . '/'.$filenam, $content);
    }
