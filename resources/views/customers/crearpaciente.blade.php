    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="col-md-6">
                ...
                {{ Form::open(['route' => 'customers.CrearPaciente', 'class' => 'form-horizontal','method'=>'POST']) }}
                <div class="form-group">
                    {{Form::label('name' , 'Nombres y Apellidos', ['class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
                        {{Form::text('name', null, ['required' => 'required','class'=>'form-control letras', 'placeholder' => 'Nombres y Apellidos'])}}
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::text('phone', null, ['required' => 'required','class'=>'form-control numero', 'placeholder' => trans('customers.phone')])}}
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::textarea('info', null, ['required' => 'required','class'=>'form-control','id' => 'textarea',  'placeholder' => trans('customers.info')])}}
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {{Form::text('name', null, ['required' => 'required','class'=>'form-control letras', 'placeholder' => 'Razon Social'])}}
                    </div>
                </div>
                <div class="form-group">
                      {{Form::label('dni' , 'ruc', ['required' => 'required','class' => 'control-label col-sm-2'])}}
                        <div class="col-sm-10">
