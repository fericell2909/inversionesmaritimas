...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="text-center text-info">@lang('customers.newcustomers')</h3>
        </div>
        <div class="panel-body">
            {{ Form::open(['route' => 'customers.store', 'class' => 'form-horizontal']) }}
            <div class="col-md-6">
                <div class="form-group">
                    {{Form::label('name' , trans('customers.name'), ['required' =>'required','class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                      {{Form::label('dni' , trans('customers.dni'), ['required' =>'required','class' => 'control-label col-sm-2'])}}
                        <div class="col-sm-10">
                            <input class="form-control" maxlength="8" placeholder="Dni" name="dni" type="number" id="dni" required>
                        </div>
                </div>
                <div class="form-group">
                    {{Form::label('phone' , trans('customers.phone'), ['required' =>'required','class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    {{Form::label('info' , trans('customers.info'), ['required' =>'required','class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
