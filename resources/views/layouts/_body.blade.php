            ...
            @if(Auth::user()->hasAnyRole(['admin','superadmin']))
                <div class="navbar navbar-inverse navbar-fixed-left">
                    ...
                    <ul class="nav navbar-nav"  style ="margin-top: 5px;">
                        ...
                        <li class="{{ set_active(['cotizaciones', 'cotizaciones/*']) }}"><a href="{{url('/cotizaciones/create')}}"
                                                                              title="@lang('cotizaciones.cotizar')"
                                                                              data-toggle="tooltip"><i
                        ...
                        <li class="{{ set_active(['subcategory', 'subcategory/*']) }}"><a href="{{url('/subcategory')}}"
