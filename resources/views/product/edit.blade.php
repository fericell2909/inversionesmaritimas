...
@section('content')
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-6 col-xs-12">
                <div class="form-group">
                    {{Form::label('Category',trans('products.subcategory'), ['class' => 'control-label col-sm-2'])}}
                    <div class="col-sm-10">
                        ...
                        <div class="col-sm-10">
                            <select class="form form-control" name="imname" id="imname">
                                @foreach($provider as $prov)
                                    @if($prov->name == $product->p_imname)
                                        <option selected value="{{$prov->name}}">{{$prov->name}}</option>
                                    @else
                ...
                <div class="form-group text-center">
                    <img src="{{asset('upload').'/'.$product->p_image}}" width="150">
                </div>
