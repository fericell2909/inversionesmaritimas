<?php $__env->startSection('title', '| Registrar Cotizacion'); ?>
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            ...
            <div class="form-group row">
                    <div class="col-sm-3">
                        <?php echo e(Form::label('fechadocumento','Fecha de Cotizacion')); ?>
                ...
                <div id="salesModelBody">
                    <?php $__currentLoopData = $product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <p class='text-left'><?php echo e(str_limit($pro->p_desc,400)); ?></p>"
                                data-discount="<?php echo e($pro->p_discount); ?>" data-id="<?php echo e($pro->p_id); ?>"
                                data-price="<?php echo e($pro->p_price); ?>">
                            <?php if($pro->p_image !== NULL): ?>
                                <img src="<?php echo e(asset('upload').'/'.$pro->p_image.''); ?>" width="50">
                            <?php endif; ?>
                            <?php echo e($pro->p_bname); ?>
        ...
        <div class="col-md-4 pull-right" id="divOrder" style="display: none;">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="col-md-12">
                        <?php echo e(Form::open(['route' => 'cotizaciones.store' , 'id' => 'orderForm'])); ?>
