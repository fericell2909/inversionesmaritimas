            ...
            <?php if(Auth::user()->hasAnyRole(['admin','superadmin'])): ?>
                <div class="navbar navbar-inverse navbar-fixed-left">
                    ...
                    <ul class="nav navbar-nav"  style ="margin-top: 5px;">
                        ...
                        <li class="dropdown" title=" Productos" data-toggle="tooltip">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-product-hunt fa fa-2x">
                        ...
                        <li class="<?php echo e(set_active(['cotizaciones', 'cotizaciones/*'])); ?>"><a href="<?php echo e(url('/cotizaciones/create')); ?>"
                                                                              title="<?php echo app('translator')->getFromJson('cotizaciones.cotizar'); ?>"
                                                                              data-toggle="tooltip"><i
                                        class="fa fa-calculator fa fa-2x" aria-hidden="true"></i></a></li>
                        ...
                        <li class="<?php echo e(set_active(['subcategory', 'subcategory/*'])); ?>"><a href="<?php echo e(url('/subcategory')); ?>"
                                                                                    title="Sub Categorias"
                                                                                    data-toggle="tooltip"><i
                                        class="fa fa-braille fa fa-2x" aria-hidden="true"></i></a></li>
