<?php $__env->startSection('title', '| Reporte de Stock de Productos'); ?>
...
<?php $__env->startSection('content'); ?>
        <a href="<?php echo e(url('analysis/stockmedicamentos') .'/1'); ?>">
        ...
        <a href="<?php echo e(url('analysis/stockmedicamentos') .'/2'); ?>" target="_blanck">
                                            <button class="btn btn-xs btn-white">
