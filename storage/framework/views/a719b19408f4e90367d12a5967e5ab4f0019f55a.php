<?php $__env->startSection('title', '| Otros'); ?>
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
            
            <h1 class="text-info text-center"><?php echo app('translator')->getFromJson('setting.barcode'); ?></h1>
            
            <div class="panel-body">
                <?php echo e(Form::model(get_setting() ,['route' => ['setting.otherUpdate' , get_setting()->id],'method' => 'PUT', 'class' => 'form-horizontal' ])); ?>
                        ...
                        <div id="barcode-dropdown">
                            <div class="dropdown">
                                <button class="btn btn-info dropdown-toggle" data-toggle="dropdown" type="button">
                                    <?php echo e(get_setting()->barcode_type); ?>
