<?php $__env->startSection('title', '| Ver Cotizacion'); ?>
...
<?php $__env->startSection('content'); ?>
        <a href="<?php echo e(url('cotizaciones/invoice') .'/' . $orders[0]->id); ?>">
        ...
        <a href="<?php echo e(url('cotizaciones/imprimir') .'/' . $orders[0]->id . '/1'); ?>" target="_blanck">
                                            <button class="btn btn-xs btn-white">
    ...
    <div class="panel panel-default">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <td style="width: 25%;text-align:right">
             COTIZACION N°: <?php echo e($orders[0]->codigogenerado); ?>
